...
test("TC: WEENSPACE_1 Create basic product type @e2e @product-type", async ({ page }) => {
...
test("TC: WEENSPACE_2 Create gift card product type @e2e @product-type", async ({ page }) => {
  const productTypePage = new ProductTypePage(page);
...
test("TC: WEENSPACE_184 As a admin I can edit product type @e2e @product-type", async ({
  page,
}) => {
  const productTypePage = new ProductTypePage(page);
...
test("TC: WEENSPACE_185 As a admin user I can delete product type with assigned products @e2e @product-type", async ({
  page,
}) => {
  const productTypePage = new ProductTypePage(page);
...
test("TC: WEENSPACE_186 As a admin user I can delete several product types @e2e @product-type", async ({
  page,
}) => {
  const productTypePage = new ProductTypePage(page);
