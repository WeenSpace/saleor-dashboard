...
test("TC: WEENSPACE_8 User should be able to navigate to order list as a staff member using ORDER permission @e2e", async () => {
...
test("TC: WEENSPACE_9 User should be able to navigate to draft list as a staff member using ORDER permission @e2e", async () => {
