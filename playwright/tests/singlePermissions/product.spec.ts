...
test("TC: WEENSPACE_23 User should be able to navigate to product list as a staff member using PRODUCT permission @e2e", async () => {
  await home.goto();
...
test("TC: WEENSPACE_24 User should be able to navigate to collections list as a staff member using PRODUCT permission @e2e", async () => {
  await home.goto();
  await home.welcomeMessage.waitFor({ state: "visible", timeout: 30000 });
...
test("TC: WEENSPACE_25 User should be able to navigate to categories list as a staff member using PRODUCT permission @e2e", async () => {
  await home.goto();
  await home.welcomeMessage.waitFor({ state: "visible", timeout: 30000 });
