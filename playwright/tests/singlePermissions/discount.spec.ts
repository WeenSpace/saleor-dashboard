...
test("TC: WEENSPACE_6 User should be able to navigate to discount list as a staff member using DISCOUNTS permission @e2e", async () => {
...
test("TC: WEENSPACE_7 User should be able to navigate to voucher list as a staff member using DISCOUNTS permission @e2e", async () => {
