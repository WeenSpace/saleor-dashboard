...
test("TC: WEENSPACE_193 Should go to Navigation page @navigation @e2e", async () => {
...
test("TC: WEENSPACE_198 Should update existing menu @navigation @e2e", async () => {
...
test("TC: WEENSPACE_196 Should bulk delete menus from the list @navigation @e2e", async () => {
  await navigation.goToNavigationView();
